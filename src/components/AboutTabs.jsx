            ...
            <div className="tab-content" id="pills-tabContent">
                    ...
                    <div className="about-desc">
                        ...
                        <p>Established in March 2025, Process oil & Gas emerged as a powerhouse in the industrial sector. With a commitment to
                             ...
                             . Over the years, it has pioneered groundbreaking solutions, revolutionizing
                              ...
                              and a vision for a sustainable future </p>
                ...
                <div className="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab" tabIndex="0">
                    <div className="about-desc">
                        ...
                        <p>At  Process oil & Gas, our mission is to empower industries worldwide through relentless innovation and unwavering 
                            commitment to excellence. We strive to deliver cutting-edge solutions that optimize productivity, enhance efficiency, 
                            and drive sustainable growth. Our goal is to be a trusted partner, shaping the future of industrial advancement with 
                ...
                <div className="tab-pane fade" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab" tabIndex="0">
                    <div className="about-desc text-black">
                        <h1 className="">About Our Support</h1>
